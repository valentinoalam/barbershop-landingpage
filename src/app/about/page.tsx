...
const page = () => {
  return (
    <div className="relative flex items-center justify-center overflow-hidden bg-white n ">
        <div
            className="relative h-full px-4 pb-20 mx-auto md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
            ...
            <div className="relative ">
                ...
                <h2 className="max-w-lg mb-6 text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                    We make you look
                    <span
                    className="inline-block px-4 my-1 font-bold bg-white border-b-8 border-g4 text-g4 animate__animated animate__flash">different</span>
                </h2>
